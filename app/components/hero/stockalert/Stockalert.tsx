    ...
    <section className="w-full bg-[#FF383C26] p-4 rounded-xl mt-4">
      <div className="flex justify-between w-full">
        <nav className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold">{t("hero.title1")}</h2>
        </nav>
        <Link href="/alerts" className=" text-[#FF383C] px-4 py-2 rounded-lg">{t("hero.viewAll")}</Link>
      </div>
      <div className="flex flex-col gap-2 mt-4">
        <div className="flex items-center justify-between">
          <nav className="flex items-center gap-2">
            <Products />
            <p className="font-semibold">{t("hero.title1")}</p>
          </nav>
          <nav>
